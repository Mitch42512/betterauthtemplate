...
export default function Footer({ className = "" }: FooterProps) {
  return (
    <div className={`bg-gray-900 text-white py-8 sm:py-12 lg:py-16 ${className}`}>
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/login" className="block text-gray-300 hover:text-white transition-colors text-sm sm:text-base">
                Sign In
              </Link>
              <Link href="/register" className="block text-gray-300 hover:text-white transition-colors text-sm sm:text-base">
                Create Account
              </Link>
              <Link href="/dashboard" className="block text-gray-300 hover:text-white transition-colors text-sm sm:text-base">
                Dashboard
              </Link>
        ...
        <div className="border-t border-gray-700 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center">
          <p className="text-gray-400 text-sm sm:text-base">&copy; 2024 Crextio. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
